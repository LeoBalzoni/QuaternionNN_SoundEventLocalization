...
class QuaternionConv(Layer):
    ...
    def build(self, input_shape):
        ...
        self.kernel = self.add_weight(
            shape=self.kernel_shape,  #TODO qui hai cambiato, era solo self.kernel_shape
        ...
        if self.use_bias:
            ...
            self.bias = self.add_weight(
                shape=bias_shape, #TODO modificato, prima era solo bias_shape
